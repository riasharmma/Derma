...
useEffect(()=>{
  if(user){
    ...
    backendAuthService.emailLinkUser()
  }
},[user]);
        ...
        <Dialog as="div" className="relative z-10" onClose={closeModal}>
          ...
          <div className="fixed inset-0 overflow-y-auto">
            <div className="flex min-h-full items-center justify-center p-4 text-center">
              ...
              >
                <div className="bg-white shadow rounded relative lg:w-1/3  md:w-1/2 w-full p-10 mt-16">
                  <XMarkIcon className="absolute w-6 cursor-pointer" onClick={closeModal}/>
                    ...
                    <button aria-label="Continue with google" role="button" onClick={handleGoogleLogin}className="focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-gray-700 py-3.5 px-4 border rounded-lg border-gray-700 flex items-center w-full mt-10">
                    ...
                    <div>
                        ...
                        <input onChange={handleEmail} aria-label="enter email adress" role="input" type="email" className="bg-gray-200 border rounded focus:outline-none text-xs font-medium leading-none text-gray-800 py-3 w-full pl-3 mt-2" />
                    </div>
                    <div className="mt-8">
